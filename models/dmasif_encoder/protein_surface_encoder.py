...
from models.dmasif_encoder.geometry_processing import (
    curvatures,
    atoms_to_points_normals,
)
from models.dmasif_encoder.helper import diagonal_ranges
from models.dmasif_encoder.benchmark_models import dMaSIFConv_seg
...
class dMaSIF(nn.Module):
    ...
    def features(self, P):
        ...
        if ("xyz" not in P):  # Compute the pseudo-surface directly from the atoms
    ...
    def embed(self, P):
        ...
        P["embedding_1"] = self.conv(features) #### Output features 
